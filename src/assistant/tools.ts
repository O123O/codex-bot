...
export const ASSISTANT_TOOL_SCHEMAS = {
  ...
  inspect_worker_conversation: z.object({
    ...
    include_commentary: z.boolean().describe("include worker commentary messages; false returns user messages and final answers only").default(false),
  }).strict(),
  ...
  compact_session: z.object({ nickname }).strict(),
