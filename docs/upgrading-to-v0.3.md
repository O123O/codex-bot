...
UnsetEnvironment=QIYAN_HOME TELEGRAM_BOT_TOKEN TELEGRAM_OWNER_ID TELEGRAM_DESTINATION_CHAT_ID SLACK_APP_TOKEN SLACK_BOT_TOKEN SLACK_USER_TOKEN SLACK_OWNER_USER_ID PRIMARY_CHAT_APP ASSISTANT_WORKDIR DATA_DIR SESSION_REGISTRY_PATH CODEX_BINARY MAX_CONCURRENT_TURNS MAX_COLLECT_COUNT MCP_HOST MCP_PORT ATTACHMENT_MAX_BYTES ATTACHMENT_STORE_MAX_BYTES ASSISTANT_SANDBOX_MODE WEIXIN_BOT_TOKEN WEIXIN_BOT_ID WEIXIN_OWNER_USER_ID QIYAN_BOT_MCP_TOKEN
Restart=on-failure
RestartSec=5
